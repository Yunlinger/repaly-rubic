  ...
  <div class="container">
    <div class="paper">
      ...
      <div style="position: fixed; right: 24px; top: 20%; width: 150px;">
        <div v-for="(topic, idx) of paper.topics" :key="idx">
          ...
          <div style="display: flex; flex-direction: row; flex-wrap: wrap; margin-top: 8px;">
            <div
              ...
              class="goto-button"
              :style="{ background: (marking ? (commitData.answers[question.ID].judgeID ? '#1890ff' : 'yellow') : (commitData.answers[question.ID].score ? '#1890ff' : 'red'))}"
        ...
        <div style="font-size: 16px; margin-top: 32px;" @click="back">
