<template>
  <div class="container">
    <div class="paper">
              ...
              <div class="caption">
                ...
                <template v-for="(item, capIdx) of splitWithBrackets(question.caption1)">
                  <template v-if="item.isBlank">
                    <template v-for="an of ['answer1','answer2','answer3','answer4','answer5','answer6','answer7','answer8']">
      ...
      <div v-if="started" style="position: fixed; right: 24px; top: 20%; width: 150px;">
  ...
  created() {
    ...
    this.$on('global:ticker', (msg) => {
      ...
      if (!this.started) {
        ...
        this.waitTime = moment({ h: hours, m: minutes, s: seconds }).format('H小时m分s秒')
      } else if (!this.ended) {
          ...
          for (let q of t.questions) {
            ...
            if (q.type === api.QUESTION_TYPE_FILLBLANK) {
              if (this.commitData.answers[q.ID].answer1 === q.answer1 &&
                ...
                this.commitData.answers[q.ID].answer5 === q.answer5 &&
                this.commitData.answers[q.ID].answer6 === q.answer6 &&
                this.commitData.answers[q.ID].answer7 === q.answer7 &&
                this.commitData.answers[q.ID].answer8 === q.answer8) {
                this.commitData.answers[q.ID].score = t.scorePerQuestion
                totalScore += t.scorePerQuestion
              }
            }
      ...
      if (cache) {
        ...
        for (let id in cache.answers) {
          if (this.commitData.answers[id]) {
            ...
            this.commitData.answers[id].answer5 = cache.answers[id].answer5
            this.commitData.answers[id].answer6 = cache.answers[id].answer6
            this.commitData.answers[id].answer7 = cache.answers[id].answer7
            this.commitData.answers[id].answer8 = cache.answers[id].answer8
          }
        }
      }
    },
